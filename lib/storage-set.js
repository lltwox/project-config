 ...
 *
 */
StorageSet.prototype.addArgv = function() {
    var store = new Storage({}, 'argv');
 ...
 *
 */
StorageSet.prototype.addEnv = function() {
    var store = new Storage({}, 'env');
